...
api.test = async (titleSlug, code, callback) => {
    chrome.getCookies(config.urls.base, async (err, cookies) => {
        response = await axios({
            method: 'post',
            url: config.urls.test.replace('$value', titleSlug),
            headers: {                
...
api.submit = async (titleSlug, code, callback) => {

    chrome.getCookies(config.urls.base, async (err, cookies) => {
        response = await axios({
            method: 'post',
            url: config.urls.submit.replace('$value', titleSlug),
            headers: {
                cookie: '__cfduid=d5e8d73e8ce852909460fb62b159385b91565080935; _ga=GA1.2.632816059.1565081018; __stripe_mid=4dac6ebb-79e3-4244-a92d-f656edf169c2; _gid=GA1.2.512198855.1583808600; __atuvc=6%7C7%2C5%7C8%2C9%7C9%2C1%7C10%2C1%7C11; csrftoken=e8nYqAaBscuK3EPKPFC8aHl9DsCTvPTvfGcqq10LEYkdSg5U57cSU6lWxKICjDvm; LEETCODE_SESSION=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..GUgrmWCiu_6amGkyqbngVpJj76GENBi4A8zVTWrlaV0; c_a_u=c25pc2hhbDMz:1jBwm6:f3WPUXxqRInOsI86meywCOY19mQ',
                'x-csrftoken': 'e8nYqAaBscuK3EPKPFC8aHl9DsCTvPTvfGcqq10LEYkdSg5U57cSU6lWxKICjDvm',
                origin: config.urls.base,
